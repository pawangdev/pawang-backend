...
router.post('/auth/change-profile', authMiddleware, userController.changeProfile);
router.post('/auth/reset-password/request', userController.requestResetPasswordToken);
router.post('/auth/reset-password/verify', userController.verifyResetPasswordToken);
...
router.delete('/transactions/delete/:id', authMiddleware, transactionController.destroy);
...
router.post('/categories/create/:id', authMiddleware, categoryController.create);
router.put('/categories/update/:id/:subcategoryId', authMiddleware, categoryController.update);
router.delete('/categories/delete/:id/:subcategoryId', authMiddleware, categoryController.destroy);
...
router.post('/task-reminders/create', authMiddleware, taskReminderController.create);
router.put('/task-reminders/update/:id', authMiddleware, taskReminderController.update);
router.delete('/task-reminders/delete/:id', authMiddleware, taskReminderController.destroy);
